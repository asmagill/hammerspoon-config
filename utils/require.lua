...
-- Honestly never really used this much once _gc issues with reload got sorted out...
...
----- utils.require.requirePath(path[, output]) -> table-of-modules
...
----- utils.require.updatePaths(label, command|table[, append])
