--
-- Annoyances in hammerspoon functions/modules/whatever
--
-- Some of them were design decisions by me, some design decisions by others... in any case, they
-- annoy me now, but not enough to make a huge deal about whether or not the actual module should
-- be changed/updated.
--
...
if settings.keys then print("++ settings.keys already exists, skipping") else
    settings.keys = function()
        local results = {}
        for i,v in ipairs(hs.settings.getKeys()) do table.insert(results, v) end
        table.sort(results)
