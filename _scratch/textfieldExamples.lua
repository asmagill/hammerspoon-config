...
manager:add(guitk.element.textfield.newTextField("I am a text field"):tooltip("newTextField"):editingCallback(editFn))
...
manager:add(guitk.element.textfield.newTextField("Another one!"):tooltip("added for tabbing"):editingCallback(editFn))
manager:add(guitk.element.textfield.newTextField("Another two!"):tooltip("and shift-tabbing"):editingCallback(editFn))
